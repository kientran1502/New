            ...
            <form id="login-form">
                <div class="modal-header">
                    <h5 class="modal-title d-flex align-items-center">
                        <i class="bi bi-person-circle fs-3 me-2"></i> Sign in
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <button type="submit" class="btn btn-dark shadow_none">Sign in</button>
                        <button type="button" class="btn text-secondary text-decoration-none p-0" data-bs-toggle="modal" data-bs-target="#forgotModel" data-bs-dismiss="modal">
                            Forgot Password?
                        </button>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="register-form">
                <div class="modal-header">
                    <h5 class="modal-title d-flex align-items-center">
                        <i class="bi bi-person-add fs-3 me-2"></i> Sign up
                    </h5>
                    <button type="reset" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base d-block w-100">
                        Note: Your detail must match with your ID (Passport, driving license, etc...)
                    ...
                    <div class="text-center my-1">
                        <button type="submit" class="btn btn-dark shadow_none">Sign up</button>
                    </div>
                </div>
            </form>
        </div>
            ...
            <form id="forgot-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2 text-end">
                        ...
                        <button type="submit" class="btn btn-dark shadow_none">Send link</button>
                    </div>
                </div>
            </form>
        </div>
