        ...
        echo <<<data
                <div class="col-md-2 mb-3">
                    <div class="card bg-dark text-white" style="position: relative;">
                        <img src="$path$row[picture]" class="card-img img-fluid" style="height: 200px; object-fit: cover;">
                        <div class="card-img-overlay text-end">
                            <button type="button" onclick="rem_member($row[sr_no])" class="btn btn-danger btn-sm shadow-none position-absolute" style="top: 0px; right: 0px;">
