<div class="container-fluid bg-dark text-light p-3 d-flex align-items-center justify-content-between sticky-top">
    <h3 class="mb-0 h-font">Viva la Vida</h3>
...
<div class="col-lg-2 bg-dark border-top border-3 border-secondary" id="dashboard-menu">
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid flex-lg-column align-items-stretch">
            ...
            <button class="navbar-toggler shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#adminDrop" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="adminDrop">
                ...
                <ul class="nav nav-pills flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse show px-3 mb-1" id="bookingLinks">
                            <ul class="nav nav-pills flex-column rounded  border-secondary">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="booking_record.php">Bookings Record</a>
                                </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="user2.php">User Manage</a>
                    </li>
                    <li class="nav-item">
